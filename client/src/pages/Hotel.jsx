...
// Date.prototype.datediff = (first, second) => {
...
const Hotel = () => {
  ...
  // console.log(datediff(dates[1], dates[0]));
      ...
      <div className="hotel">
        {open && (
          <div className="slider">
            ...
            <IoMdClose className="close" onClick={() => setOpen(!open)} />
            {/* <FontAwesomeIcon
            ...
            <BsChevronLeft className="left" onClick={() => handleMove('l')} />
            ...
            <BsChevronRight className="right" onClick={() => handleMove('r')} />
          </div>
        )}
        <div className="wrapper">
          ...
          <div className="details">
            <div className="detailsTexts">
              <h1 className="title">Stay in the heart of City</h1>
              <p className="desc">
